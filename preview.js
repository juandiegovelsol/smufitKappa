...
/* function cmykToRgb(c, m, y, k) {
  ...
  // Convert RGB to RGBA by defaulting alpha to 1 (fully opaque)
  var rgba = {
    red: r,
    green: g,
    blue: b,
...
/* var u;
var dlg = new Window("dialog", "Color Preview");

var colorPanel = dlg.add("panel");
colorPanel.size = [120, 30];
colorPanel.text = "Color Preview";

colorPanelGraphics = colorPanel.graphics;
colorPanel.fillBrush = colorPanelGraphics.newBrush(
  colorPanelGraphics.BrushType.SOLID_COLOR,
  [0, 1, 0, 1.0]
);
