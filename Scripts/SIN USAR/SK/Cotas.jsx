...
/* MODIFICACIONES REALIZADAS POR JoMaRoNe para la planta de SK Canovelles
* Traducción de los términos.
*
* Se añade lista deplegable para poder seleccionar el tamaño de los textos.
* 
* En el posicionamiento de los objetos [20,40,150,40] se corresponde a [izquierda,superior,derecha, inferior]
* 
* Se añade a la etiqueta de medidas las unidades definidas en el fichero, no se definen todas las que hay, solo las más comunes.
* 
*/
