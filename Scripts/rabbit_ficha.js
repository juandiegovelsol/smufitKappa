try {
            ...
            additionalOKButton.onClick = function () {
              var flexoDigitalV =
                flexoDigital.selection !== null
                  ...
                  : "Digital";
              var acabadoV =
                acabado.selection !== null ? acabado.selection.text : "-";
              var impresoraV =
                impresora.selection !== null ? impresora.selection.text : "-";
              var canalV =
                canal.selection !== null ? canal.selection.text : "-";
              var troquelV = troquel.text || "-";
              var porcentajeImpV = porcentajeImp.text || "-";
              var selectedReference =
                referenceDropdown.selection !== null
                  ? referenceDropdown.selection.text
                  : "-";
              ...
              for (var k = 0; k < textFrames.length; k++) {
                var textFrame1 =
                  activeDocument.textFrames[textFrames[k].position];
                UpdateNow(
  ...
  /*  function addColorRow(parent, labelText, sourceDoc) {
    ...
    var colorButton = colorGroup.add("button", undefined, "Selecciona Color");

    colorButton.onClick = function () {
      var colorDialogAddColorRow = new Window("dialog", "Selecciona Color");
      var colorGroupDialog = colorDialogAddColorRow.add("group");
      ...
      var okButton = colorDialogAddColorRow.add("button", undefined, "OK");
      var cancelButton = colorDialogAddColorRow.add(
        "button",
        undefined,
        "Cancel"
      );
      ...
      colorDialogAddColorRow.show(); // Show the dialog window
    };
  }
